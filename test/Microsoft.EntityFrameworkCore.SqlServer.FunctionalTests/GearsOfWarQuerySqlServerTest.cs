...
LEFT JOIN (
    ...
    FROM [Gear] AS [o.Gear]
    WHERE ([o.Gear].[Discriminator] = N'Officer') OR ([o.Gear].[Discriminator] = N'Gear')
...
LEFT JOIN (
    ...
    WHERE ([w.Owner].[Discriminator] = N'Officer') OR ([w.Owner].[Discriminator] = N'Gear')
...
LEFT JOIN (
    ...
    WHERE ([ct1.Gear].[Discriminator] = N'Officer') OR ([ct1.Gear].[Discriminator] = N'Gear')
...
LEFT JOIN (
    ...
    WHERE ([ct.Gear].[Discriminator] = N'Officer') OR ([ct.Gear].[Discriminator] = N'Gear')
...
LEFT JOIN (
    ...
    FROM [Gear] AS [g2]
    WHERE ([g2].[Discriminator] = N'Officer') OR ([g2].[Discriminator] = N'Gear')
